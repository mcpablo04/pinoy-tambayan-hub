...
export type StationEx = BaseStation & {
  description?: string;
  genre?: string;
  city?: string;
  country?: string;
...
// IMPORTANT: verify that you have the right to embed each stream.
// If not, prefer official players via `officialEmbedUrl` or link to website.
...
export const STATIONS: StationEx[] = [
  {
    ...
    description:
      "A top FM station in Metro Manila playing OPM, pop hits, and feel-good tracks.",
  },
  {
    id: "easy-rock",
    ...
    description:
      "Laid‑back classics and love songs—soft rock and adult contemporary all day.",
  },
  {
    id: "energy-fm",
    ...
    description:
      "High‑energy Top 40, OPM, and variety programming with fun on‑air personalities.",
  },
  {
    id: "win-radio",
    name: "91.5 Win Radio Manila",
    url: "https://stream-172.zeno.fm/2ss1hgnu6hhvv",
    ...
    description:
      "OPM and pop favorites plus masa‑friendly shows for the daily commute.",
  },
  {
    id: "barangay-ls",
    name: "97.1 Barangay LS Manila",
    url: "https://magic.radioca.st/stream", // ⚠️ Verify this is the official LS stream before using.
    ...
    description:
      "Masa hits, OPM, and lively banter—#TugstuganNa with Barangay LS 97.1.",
  },
  {
    id: "home-radio",
    ...
    description:
      "Easy listening and variety programming—companion radio for work and study.",
  },
  {
    id: "star-fm",
    name: "102.7 Star FM Manila",
    url: "https://stream-24.zeno.fm/536cwdq78heuv?zs=QvLMk8MiRVyUrdV4IHH_Dg",
    ...
    description:
      "Top 40, OPM, and news updates—Star FM blends music and info for the city.",
  },
  {
    id: "mor-entertainment",
    name: "MOR entertainment",
    url: "https://stream-152.zeno.fm/0ha8ftewqp8uv",
    ...
    description:
      "MOR’s online programming with OPM/pop and fan‑favorite DJs and segments.",
  },
  {
    id: "yes!",
    ...
    description:
      "Regional masa hits and OPM bangers—Yes! The Best Dagupan’s online stream.",
  },
  {
    id: "dzrh",
    name: "666 AM DZRH",
    ...
    description:
      "Philippines’ pioneering news and public affairs radio—headlines and commentary.",
  },
  {
    id: "dzmm",
    name: "630 AM DZMM",
    url: "http://us1.amfmph.com:8852/stream",
    ...
    description:
      "News and public service programming with nationwide coverage and updates.",
  },
  // …add more as needed
];
